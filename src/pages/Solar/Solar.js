    ...
    if (active && payload) {
      return (
        <div className="custom-tooltip">
          ...
          <p className="label"> Initial : <CurrencyFormat value={payload[0].value} displayType={'text'} thousandSeparator={true} prefix={'$'}/></p>
          <p className="label"> Return : <CurrencyFormat value={payload[1].value} displayType={'text'} thousandSeparator={true} prefix={'$'}/></p>
        </div>
      );
    }
